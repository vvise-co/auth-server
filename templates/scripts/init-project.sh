...
echo ""
echo "============================================"
echo "REQUIRED ENVIRONMENT VARIABLES (Koyeb)"
echo "============================================"
echo ""
...
echo "| AUTH_SERVER_URL      | Central auth server URL (env + build arg) |"
echo "| CORS_ALLOWED_ORIGINS | Your app URL                        |"
echo ""
echo "IMPORTANT: Set AUTH_SERVER_URL as BOTH environment variable AND build argument!"
echo "No JWT_SECRET required! Token validation is done via introspection."
echo ""
echo "============================================"
echo "AUTH SERVER CONFIGURATION"
echo "============================================"
echo ""
echo "On your AUTH SERVER (not this client app), ensure these are set:"
echo ""
echo "| Variable                        | Value                   |"
echo "|---------------------------------|-------------------------|"
echo "| CORS_ALLOWED_ORIGIN_PATTERNS    | https://*.koyeb.app     |"
echo "| OAUTH2_ALLOWED_REDIRECT_DOMAINS | *.koyeb.app,localhost   |"
echo ""
echo "These allow client apps on *.koyeb.app to authenticate via the auth server."
echo ""
echo "============================================"
...
echo ""
echo "Options: --docker --readme --env --mvnw --frontend --backend --scripts --all"
echo ""
